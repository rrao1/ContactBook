...
public class ContactsActivity extends AppCompatActivity {
    ...
    public void randomContact(MenuItem mi) {
        Contact contact = Contact.getRandomContact(this);
        contacts.add(0, contact);
        mAdapter.notifyDataSetChanged();
//        Snackbar.make(this, R.string.snackbar_text, Snackbar.LENGTH_LONG)
//                .setAction(R.string.snackbar_action, myOnClickListener)
//                .show();

        Snackbar snackbar = Snackbar
                .make(rvContacts, "Random contact added", Snackbar.LENGTH_LONG)
